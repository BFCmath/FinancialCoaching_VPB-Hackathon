"""
Transaction Retrieval Tools for History Fetcher - Backend Migration
==================================================================
...
from backend.services.adapters import get_transaction_fetcher_service

# Get service instance (will be configured by main agent)
query_service = get_transaction_fetcher_service()
